...
export const exerciseSchema = z.object({
  ...
  normalize: z
    .object({ caseSensitive: z.boolean(), punctuation: z.boolean() })
    .default({ caseSensitive: true, punctuation: true }),
  assistedByDesign: z.boolean().optional(),
...
export const lessonSchema = z.object({
  ...
  reflection: z.string(),
  quality: z.object({
    method: z.literal("ai-authored-and-reviewed"),
    reviewedAt: z.string(),
...
export type PublicLesson = Omit<Lesson, "exercises"> & {
  exercises: PublicExercise[];
};
export const lexicalSchema = z.object({
  id: z.string(),
  word: z.string(),
  type: z.enum(["noun", "verb", "adjective", "expression"]),
...
export function publicLesson(lesson: Lesson): PublicLesson {
  return { ...lesson, exercises: lesson.exercises.map(publicExercise) };
}
