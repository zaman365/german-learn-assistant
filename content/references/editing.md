# Editing for precision and natural German
...
Treat an actual error differently from an optional stylistic alternative. **Ich schicke Ihnen den Entwurf morgen** is correct. **Den Entwurf erhalten Sie morgen** changes focus and style; it is not a correction of faulty German. Prefer revisions that improve the specific reader's understanding.

For self-correction, name the decision: “mit requires dative; Vertrag is masculine; after einem the adjective takes -en.” Then use the pattern in a new sentence on a later day. Repeating the corrected original checks repair, not independent transfer.
