...
Where _ein_ has no ending, the adjective supplies the missing **-er** or **-es** signal. This memory aid applies to the displayed pattern, not every determiner construction.
...
The important genitive masculine/neuter forms here are **-en**, not _-es_. For example: **wegen schlechten Wetters**. Do not turn “the adjective carries the article signal” into a rule without this qualification.
