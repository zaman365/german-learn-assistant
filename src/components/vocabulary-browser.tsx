  ...
  return (
    <>
        ...
        <div className="field search grow">
          ...
          <div className="row">
            ...
            <input
              ...
              placeholder="Search a word, meaning or phrase…"
            />
          </div>
        </div>
        <select
      ...
      <p className="small muted">
        {filtered.length} entries · Learn the whole package, then use it.
      </p>
      <div className="grid-two">
        {filtered.map((w) => (
          <article className="card" key={w.id}>
            <div className="row">
              <h2 lang="de" style={{ margin: 0 }}>
                {w.article && (
                  <span
                    style={{
                      color:
              ...
              <span className="badge neutral">{w.type}</span>
            </div>
            ...
            <div className="example">
              ...
              <p lang="de" className="small" style={{ marginTop: 10 }}>
                {w.example}
              </p>
      ...
      {!filtered.length && (
        <div className="empty">
          No matching entry in the published vocabulary. Try the German base
          form or its English meaning.
        </div>
      )}
    </>
  );
